...
namespace EmployeeCrudTaskAPi.Services.Employees
{
    public class EmployeeServices : IEmployeeServices
    {
        ...
        {
            var EmployeeExsits = await _crudEmployeeDBContext.Employees.FirstOrDefaultAsync(emp => emp.EmployeeId == EmployeeId);
        ...
        public async Task<SuccessResponse> UpdateById(long EmployeeId, EmployeeRequest NewModel)
        {
            ...
            if (EmployeeExsits != null)
            {
                EmployeeExsits.EmployeeName = NewModel.EmployeeName;
                EmployeeExsits.DateOfJoining = NewModel.DateOfJoining;
